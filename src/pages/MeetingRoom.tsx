...
export default function MeetingRoom() {
  ...
  const handleJoin = (meetingCode: string, isTurnOnCamera: boolean) => {
...
interface PreviewJoinMeetingProps {
  onJoin: (meetingCode: string, isTurnOnCamera: boolean) => void;
  meeting: MeetingType;
...
const PreviewJoinMeeting = ({
  ...
  const handleJoinMeeting = () => {
    onJoin(meeting.meetingCode, isTurnOnCamera);
  };
